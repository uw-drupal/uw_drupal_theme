(function (Drupal, drupalSettings, $) {
  ...
  function toggleBlur() {document.body.classList.contains('search-open') ? (searchArea.hidden = !1, searchBar.focus(), setAttributes(searchButton, { 'aria-hidden': 'false', 'aria-label': 'close search area', 'aria-expanded': 'true', role: 'search' })) : (searchArea.hidden = !0, setAttributes(searchButton, { 'aria-hidden': 'true', 'aria-label': 'open search area', 'aria-expanded': 'false', role: 'search' }));}
